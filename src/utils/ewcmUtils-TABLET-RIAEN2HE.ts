...
export const tempToPressureSimulation = (tempC: number, refrigerantId: number): number => {
  ...
  switch (refrigerantId) {
    case 9: // CO2 (R744) -> temp = (p * 2) - 50  => p = (temp + 50) / 2
      pressure = (tempC + 50) / 2;
      break;
    case 1: // R134a -> temp = (p * 8) - 30 => p = (temp + 30) / 8
      pressure = (tempC + 30) / 8;
      break;
    case 3: // R404A -> temp = (p * 10) - 50 => p = (temp + 50) / 10
    default:
